...
export default function MobileNavbar({menuOpen, setMenuOpen}:MobileNavbarProps) {
  return (
        ...
        return (
          <li key={link.url}>
            ...
            onClick={() => setMenuOpen(false)}
             href={link.url} className="text-xl font-semibold tracking-wide text-gray-200 hover:text-indigo-400 transition-colors">
            {link.label}
            </Link>
          </li>
        )
